...
WHERE quantityInStock BETWEEN 1000 AND 2000 AND buyPrice <50 OR buyPrice >150 AND productLine != "Vintage Cars";
...
WHERE orderNumber > 10250 AND STATUS NOT IN ( "Shipped","Cancelled") AND (orderDate > '2004-01-01' AND orderDate < '2005-12-31');
...
FROM orderdetails
WHERE quantityOrdered > 50 AND priceEach > 100AND productCode NOT LIKE 'S18%'
